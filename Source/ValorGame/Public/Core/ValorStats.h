...
DECLARE_STATS_GROUP(TEXT("Valor AI"), STATGROUP_ValorAI, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Camera"), STATGROUP_ValorCamera, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Character"), STATGROUP_ValorCharacter, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Player"), STATGROUP_ValorPlayer, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Spawner"), STATGROUP_ValorSpawner, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Component"), STATGROUP_ValorComponent, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Online"), STATGROUP_ValorOnline, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor GUI"), STATGROUP_ValorGUI, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor Audio"), STATGROUP_ValorAudio, STATCAT_Advanced);
DECLARE_STATS_GROUP(TEXT("Valor BP Libraries"), STATGROUP_ValorBPLibraries, STATCAT_Advanced);